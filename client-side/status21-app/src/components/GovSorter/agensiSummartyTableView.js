                        ...
                        {isLoading ? (
                            ...
                            data.map((row, idx) => (
                                <tr key={idx}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">RM {Number(row['TTL O/S AMT']).toLocaleString()}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">RM {Number(row['Total Unpaid']).toLocaleString()}</td>
                                </tr>
                            ))
                        )}
                    </tbody>
